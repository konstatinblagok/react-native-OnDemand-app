...
public class RegisterPageWebview extends Activity {
    ...
    private String weburl = Iconstant.Register_URL;
    ...
    private void initilize() {
        ...
        if (isInternetPresent) {
            ...
            Alert(getResources().getString(R.string.server_lable_header), getResources().getString(R.string.alert_nointernet));
        }
    }
    ...
    private class Callback extends WebViewClient {  //HERE IS THE MAIN CHANGE.
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            try {
                if (url.contains(Iconstant.loginUrl)) {
                    mWebView.clearHistory();
                    finish();
                } else if (url.contains(Iconstant.REGISTER_SUCCESS)) {
                    //showRegistrationSuccessDialog();
                    finish();
                } else if (url.contains(Iconstant.REGISTER_CANCEL)) {
