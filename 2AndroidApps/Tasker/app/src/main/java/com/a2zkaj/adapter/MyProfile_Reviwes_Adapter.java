...
import com.a2zkaj.Pojo.Myprofile_Reviwes_Pojo;
import com.a2zkaj.app.R;
import com.a2zkaj.app.Reviewimageviewclass;
...
public class MyProfile_Reviwes_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            view = mInflater.inflate(R.layout.tasker_review_new_design, parent, false);
