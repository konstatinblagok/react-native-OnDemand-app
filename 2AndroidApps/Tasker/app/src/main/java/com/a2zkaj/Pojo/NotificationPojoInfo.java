...
public class NotificationPojoInfo {
    ...
    public ArrayList<com.a2zkaj.Pojo.NotificationMessageInfo> getNotificationMessageInfo() {
        return NotificationMessageInfo;
    }

    public void setNotificationMessageInfo(ArrayList<com.a2zkaj.Pojo.NotificationMessageInfo> notificationMessageInfo) {
