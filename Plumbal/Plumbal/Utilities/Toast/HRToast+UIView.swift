...
let HRToastPositionDefault : AnyObject  =   "bottom" as AnyObject
let HRToastPositionTop : AnyObject      =   "top" as AnyObject
let HRToastPositionCenter : AnyObject   =   "center" as AnyObject

// activity
let HRToastActivityWidth  :  CGFloat  = 100.0
let HRToastActivityHeight :  CGFloat  = 100.0
let HRToastActivityPositionDefault : AnyObject    = "bottom" as AnyObject
    ...
    */
    ...
    func showToast(toast: UIView, duration: Double, position: AnyObject) {
        ...
        if existToast != nil {
            ...
            self.hideToast(toast: existToast!, force: true);
        }
    ...
    */
    ...
    func centerPointForPosition(_ position: AnyObject, toast: UIView) -> CGPoint {
        if position is String {
            ...
            if position.lowercased == HRToastPositionTop as! String {
                return CGPoint(x: viewSize.width/2, y: toastSize.height/2 + HRToastVerticalMargin)
            } else if position.lowercased == HRToastPositionDefault as! String {
                return CGPoint(x: viewSize.width/2, y: viewSize.height - toastSize.height/2 - HRToastVerticalMargin)
            } else if position.lowercased == HRToastPositionCenter  as! String  {
