...
class DLHamburguerContainerViewController: UIViewController {
    ...
    func show() {
        ...
        UIView.animate(withDuration: self.hamburguerViewController.animationDuration, animations: { () -> Void in
            ...
            if self.hamburguerViewController.delegate != nil {
                self.hamburguerViewController.delegate?.hamburguerViewController!(hamburguerViewController: DLHamburguerViewController(), didShowMenuViewController: self.hamburguerViewController.menuViewController)
            }
        }
    }
    ...
    func hideWithCompletion(completion: (() -> Void)?) {
        ...
        self.hamburguerViewController.delegate?.hamburguerViewController!(hamburguerViewController: DLHamburguerViewController(), willHideMenuViewController: self.hamburguerViewController.menuViewController)
        ...
        UIView.animate(withDuration: self.hamburguerViewController.animationDuration, animations: { () -> Void in
            ...
            self.hamburguerViewController.delegate?.hamburguerViewController!(hamburguerViewController: DLHamburguerViewController(), didHideMenuViewController: self.hamburguerViewController.menuViewController)
            completion?()
        }
    }
    ...
    func panGestureRecognized(recognizer: UIPanGestureRecognizer) {
        // inform the delegate
        self.hamburguerViewController.delegate?.hamburguerViewController!(hamburguerViewController: DLHamburguerViewController(), didPerformPanGesture: recognizer)
