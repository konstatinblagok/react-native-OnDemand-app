...
-(void)addRightButton
{
    ...
    self.rightButton.titleLabel.font = [UIFont fontWithName:@"Roboto-Regular" size:15.0f];
...
-(void)growingTextViewDidEndEditing:(HPGrowingTextView *)growingTextView{
    if (self.delegate && [self.delegate respondsToSelector:@selector(inputbarTextEndEditingChat:)])
    {
        [self.delegate inputbarTextEndEditingChat:self];
    }
}
