...
open class NavigationNotice {
    ...
    fileprivate class NoticeManager {
        ...
        fileprivate var showAnimations: ((() -> Void, (Bool) -> Void) -> Void)?
        fileprivate var hideAnimations: ((() -> Void, (Bool) -> Void) -> Void)?
    ...
    fileprivate var statusBarHidden: Bool? = NavigationNotice.defaultStatusBarHidden
    fileprivate var statusBarStyle: UIStatusBarStyle? = NavigationNotice.defaultStatusBarStyle
    /// Common status bar style.
    open class var defaultStatusBarStyle: UIStatusBarStyle? {
    ...
    open class var defaultStatusBarHidden: Bool? {
    ...
    fileprivate var showAnimations: ((() -> Void, (Bool) -> Void) -> Void)? = NavigationNotice.defaultShowAnimations
    /// Common animated block of show. Default is `nil`.
    open class var defaultShowAnimations: ((() -> Void, (Bool) -> Void) -> Void)? {
        set { sharedManager.showAnimations = newValue }
        get { return sharedManager.showAnimations }
    }
    fileprivate var hideAnimations: ((() -> Void, (Bool) -> Void) -> Void)? = NavigationNotice.defaultHideAnimations
    /// Common animated block of hide. Default is `nil`.
    open class var defaultHideAnimations: ((() -> Void, (Bool) -> Void) -> Void)? {
    ...
    open class func statusBarHidden(_ hidden: Bool) -> NavigationNotice {
        let notice = NavigationNotice()
    ...
    open class func statusBarStyle(_ style: UIStatusBarStyle) -> NavigationNotice {
        let notice = NavigationNotice()
    ...
    /// Set status bar hidden of notification.
    open func statusBarHidden(_ hidden: Bool) -> NavigationNotice {
    ...
    /// Set status bar style of notification.
    open func statusBarStyle(_ style: UIStatusBarStyle) -> NavigationNotice {
    ...
    open func showAnimations(_ animations: @escaping (() -> Void, (Bool) -> Void) -> Void) -> Self {
    ...
    open func hideAnimations(_ animations: @escaping (() -> Void, (Bool) -> Void) -> Void) -> Self {
